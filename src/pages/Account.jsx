  ...
  const achievementCategories = [
    {
      ...
      achievements: [
        ...
        },
        {
          ...
          description: "Added a bio and uploaded an avatar.",
          icon: FiUser,
        ...
        },
        {
          id: 3,
          title: "Hello World",
          description: "Asked your very first question.",
          icon: FiHelpCircle,
      ...
      achievements: [
        {
          id: 4,
          title: "Helpful Hand",
          description: "Answer 50 questions to aid the community.",
          icon: FiMessageSquare,
          color: "text-emerald-500",
          bg: "bg-emerald-100 dark:bg-emerald-900/30",
          progress: 32,
        ...
        },
        {
          id: 6,
          title: "Trendsetter",
          description: "Have a question viewed over 500 times.",
          icon: FiEye,
      ...
      achievements: [
        {
          id: 8,
          title: "Gold Standard",
          description: "Receive 5 gold badges for excellent answers.",
          icon: FiAwardIcon,
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                      <div>
                        <h3 className="text-2xl font-black flex items-center gap-2 mb-1">
                          <FiAward className="w-7 h-7 text-blue-200" /> Trophies
                          & Milestones
                        </h3>
                        <p className="text-blue-100 text-sm font-medium">
                          ...
                          out of {totalAchievements} total achievements.
                        </p>
                      </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {category.achievements.map((ach) => (
                            ...
                            >
                              ...
                              {ach.completed && (
                                <div
                                  className={`absolute inset-0 opacity-5 bg-linear-to-br from-transparent to-${ach.color.split("-")[1]}-500`}
                                />
                              )}
                              ...
                              <div className="relative flex gap-4 z-10">
                                {/* Icon Container */}
                                <div
                                  className={`w-14 h-14 rounded-xl flex items-center justify-center shrink-0 ${ach.completed ? ach.bg : "bg-gray-200 dark:bg-gray-700"}`}
                                >
                                  <ach.icon
                                    className={`w-7 h-7 ${ach.completed ? ach.color : "text-gray-400 dark:text-gray-500"}`}
                                  />
                                </div>
                                ...
                                <div className="flex-1 min-w-0 flex flex-col justify-center">
                                  <div className="flex justify-between items-start mb-1 gap-2">
                                    <h5
                                      className={`text-base font-bold truncate ${ach.completed ? "text-gray-900 dark:text-white" : "text-gray-600 dark:text-gray-400"}`}
                                    >
                                      {ach.title}
                                    </h5>
                                    {ach.completed && (
              ...
              <form onSubmit={handleSave} className="px-8 py-8 space-y-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex justify-between items-center px-1">
                    ...
                    <p
                      className={`text-[10px] font-bold ${formData.bio.length > 500 ? "text-red-500" : "text-gray-400"}`}
                    >
